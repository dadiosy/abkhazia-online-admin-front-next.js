...
const AttractionIndexPage = () => {
  ...
  const handleCreate = () => {
    ...
    let updateData = {
      'attraction': direction1,
      'direction': { 'id': dataDetail.directionID },
      'contents': {}
    }
...
<div style="display: flex; gap:20px; margin-bottom: 10px; overflow: auto; max-width: 100vw;">
    ...
    <div style="min-width: 327px; border-radius: 10px; padding: 18px;border-color: #c0c0c0; border-width: thin; border-style: solid;">
      ...
      const addContent = `\n<!-- -----------Hint Start-------------- -->\n
      <div class="flex flex-row gap-6 detailHint text-base md:text-lg">
      <img src='/img/hint-attraction.png'>
        <div>
          <div style="margin:0px !important;padding:0px !important;">${addText}</div>
        </div>
      </div>
      <!-- -----------Hint End-------------- -->\n\n`;
      setDataDetail({
      ...
      <div className="flex flex-col container mx-auto max-w-[1440px] mt-[60px] md:mt-[94px]">
        ...
        <div className="flex justify-center gap-x-10 my-10">
          {/* <button className={BtnActive}
            onClick={() => { Router.push('/admin/attraction/detail') }}>
            New
          </button> */}

          <button className={BtnActive} onClick={() => { Router.push('/admin/attraction') }}>
            Назад</button>
